...
ext_modules = [
    Extension(
        ...
        libraries=['ceres_shared', 'gflags', 'glog', "protobuf", "cholmod", "camd", "amd", "colamd", "cxsparse"],
        library_dirs=[ceres_lib, gflags_lib, glog_lib, protobuf_lib, cholmod_lib, amd_lib, camd_lib, colamd_lib, cxsparse_lib],
